...
DATABASES = {
    ...
    "default": {
        ...
        'NAME': os.getenv('DB_NAME','travel_hunt'),
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'sscabhay9927@gmail.com'  # Replace with your email
EMAIL_HOST_PASSWORD = 'qubg fxha ipyu hgf'  # Replace with your App Password
